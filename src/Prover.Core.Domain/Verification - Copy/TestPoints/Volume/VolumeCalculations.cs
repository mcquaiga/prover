...
namespace Prover.Domain.Verification.TestPoints.Volume
{
    ...
    internal class CorrectedVolumeCalculator : IVolumeCalculator
    {
        ...
        public CorrectedVolumeCalculator(double correctedMultiplier, double uncorrectedCalculated,
            double startCorrectedReading, double endCorrectedReading, double? temperatureFactor, double? pressureFactor,
            double? superFactor)
            : this(correctedMultiplier)
        {
            RunCalculations(uncorrectedCalculated, startCorrectedReading, endCorrectedReading, temperatureFactor,
                pressureFactor, superFactor);
        }
        ...
        private void RunCalculations(double uncorrectedCalculated, double startCorrectedReading,
            double endCorrectedReading,
            double? temperatureFactor, double? pressureFactor, double? superFactor)
        {
