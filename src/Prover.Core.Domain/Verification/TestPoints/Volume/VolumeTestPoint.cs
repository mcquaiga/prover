...
namespace Prover.Domain.Verification.TestPoints.Volume
{
    public class VolumeTestPoint : Entity<Guid>
    {
        ...
        public static VolumeTestPoint Create(IInstrument instrument, TemperatureTestPoint temperature, PressureTestPoint pressure, SuperFactorTestPoint superFactor)
        {
        ...
        public decimal PressureFactor
        {
            get
            {
                if (_pressureTest != null && (_correctorType == EvcCorrectorType.P || _correctorType == EvcCorrectorType.PTZ))
        ...
        public decimal TemperatureFactor
        {
            get
            {
                if (_temperatureTest != null && (_correctorType == EvcCorrectorType.T || _correctorType == EvcCorrectorType.PTZ))
        ...
        private VolumeTestPoint(EvcCorrectorType correctorType, TemperatureTestPoint temperatureTest, PressureTestPoint pressureTest, SuperFactorTestPoint superTest)
            : base(Guid.NewGuid())
        {
        ...
        public VolumeTestPoint(Guid id, EvcCorrectorType correctorType, IVolumeItems preTestItems, IVolumeItems postTestItems, 
