...
namespace UnionGas.MASA.Validators.CompanyNumber
{
    public class CompanyNumberValidationManager : PreTestValidationBase
    {
        ...
        public CompanyNumberValidationManager(ScreenManager screenManager, IProverStore<Instrument> instrumentStore,
            DCRWebServiceSoap webService, ILoginService<EmployeeDTO> loginService)
        {
