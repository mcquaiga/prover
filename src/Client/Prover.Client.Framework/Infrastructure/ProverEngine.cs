...
using Prover.Client.Framework.Infrastructure.DependencyManagement;
using Prover.Client.Framework.Infrastructure.Mapper;
...
namespace Prover.Client.Framework.Infrastructure
{
    ...
    /// Engine
    /// </summary>
    public class ProverEngine : IEngine
    {
        #region Fields
        ...
        protected virtual void RegisterDependencies(ProverConfig config)
        {
            var builder = new ContainerBuilder();
            
            //dependencies
            var typeFinder = new WebAppTypeFinder();
            builder.RegisterInstance(config).As<ProverConfig>().SingleInstance();
        ...
        /// </summary>
        /// <param name="config">Config</param>
        protected virtual void RegisterMapperConfiguration(ProverConfig config)
        {
            //dependencies
            var typeFinder = new WebAppTypeFinder();
        ...
        /// </summary>
        /// <param name="config">Config</param>
        public void Initialize(ProverConfig config)
        {
            //register dependencies
