...
namespace Client.Wpf.Views.Verifications.Details
{
    ...
    /// </summary>
    public partial class SiteInformationView : ReactiveUserControl<EvcVerificationViewModel>
    {
        public SiteInformationView()
        {
            ...
            this.WhenActivated(d =>
                {
                    this.OneWayBind(ViewModel, vm => vm.TestDateTime, v => v.TestDateBlock.Text, value => $"{value:g}").DisposeWith(d);
                    ...
                    this.OneWayBind(ViewModel, vm => vm.DriveType.InputType, v => v.DriveType.Text, val => Enum.GetName(val.GetType(), val)).DisposeWith(d);
