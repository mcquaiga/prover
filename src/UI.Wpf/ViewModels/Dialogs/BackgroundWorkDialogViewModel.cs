...
{
    public class BackgroundWorkDialogViewModel : ReactiveObject, IModalDialogViewModel
    {
        private CancellationTokenSource _cancellationTokenSource = new CancellationTokenSource();

        public BackgroundWorkDialogViewModel(Func<CancellationToken, Task> workAction = null)
        {
