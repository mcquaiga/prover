Public Class ZFactorCalc
    ...
    Public Property EVCUnsqrSuper As Decimal
        Get
            Return sEvcUnsqr
        End Get
        Set
    ...
    Public Property GaugePressure As Decimal
        Get
    ...
    Public Property GaugeTemp As Decimal
        Get
            Return sGaugeTemp
        End Get
        Set
    ...
    Public Property SpecGr As Decimal
        Get
            Return sSpecGr
        End Get
        Set
    ...
    Public ReadOnly Property SuperFactorSquared As Decimal
        Get
            Return Math.Pow(SuperFactor, 2)
        End Get
    End Property

    Sub New(SpecGr As Decimal, CO2 As Decimal, N2 As Decimal, GaugeTemp As Decimal, GaugePressure As Decimal)
        Me.SpecGr = SpecGr
        Me.CO2 = CO2
        Me.N2 = N2
        Me.GaugeTemp = GaugeTemp
        Me.GaugePressure = GaugePressure
        CalcFPV()
    End Sub

    Public Function CalculatePercentError() As Decimal
        Return ((EVCUnsqrSuper - SuperFactor) / SuperFactor) * 100
    End Function

    Private fpv As Double
    Private sCO2 As Decimal
    Private sEvcUnsqr As Decimal
    Private sGaugePressure As Decimal
    Private sGaugeTemp As Decimal
    Private sN2 As Decimal
    Private sSpecGr As Decimal

    Private ReadOnly Property Fp As Decimal
        Get
            Return 156.47 / (160.8 - 7.22 * Me.SpecGr + Me.CO2 - 0.392 * Me.N2)
        End Get
    End Property

    Private ReadOnly Property Ft As Decimal
        Get
