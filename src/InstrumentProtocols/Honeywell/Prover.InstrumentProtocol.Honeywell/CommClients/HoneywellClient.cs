...
using Prover.InstrumentProtocol.Honeywell.Messaging.Requests;

namespace Prover.InstrumentProtocol.Honeywell.CommClients
{
    internal class HoneywellClient : EvcCommunicationClient
    {
        public HoneywellClient(ICommPort commPort) : base(commPort)
        {
        }
