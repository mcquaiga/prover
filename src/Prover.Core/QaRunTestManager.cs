namespace Prover.Core.VerificationTests
{
    ...
    public class QaRunTestManager : IQaRunTestManager
    {
        ...
        private async Task GetInstrument(IEvcDevice instrumentType, ICommPort commPort, ISettingsService testSettings,
        ...
        public async Task InitializeTest(IEvcDevice instrumentType, ICommPort commPort, ISettingsService testSettings, CancellationToken ct = default, Client client = null, bool runVerifiers = true)
        {
