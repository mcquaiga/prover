	...
	public partial class MainWindow
	{
		public MainWindow()
		{
			...
			this.WhenActivated(d =>
			{
				...
				//ViewModel.ToolbarManager.ToolbarItems.OfType<ToolbarActionItem>()
				//         .ToObservable()
				//         .BindTo(this, x => x.ToolbarActionItemsControl.ItemsSource).DisposeWith(d);
				//ViewModel.ToolbarManager.ToolbarItems.OfType<ToolbarItem>().ToObservable().BindTo(this, x => x.ToolbarActionItemsControl.ItemsSource).DisposeWith(d);


				//this.OneWayBind(ViewModel,
				//				x => x.ToolbarManager.ToolbarItems,
				//				x => x.ToolbarActionItemsControl.ItemsSource)
				//	.DisposeWith(d);
				//values => values.OfType<ToolbarActionItem>()
