...
namespace Prover.Application.Dashboard
{
	public class ValueDashboardViewModel : DashboardItemViewModel, IDashboardValueViewModel
	{
		...
		protected ValueDashboardViewModel(string title, string groupName, IEntityCache<EvcVerificationTest> entityCache, IObservable<Func<EvcVerificationTest, bool>> parentFilter = null) : base(title, groupName) { }

		public ValueDashboardViewModel(IEntityCache<EvcVerificationTest> entityCache, string title, string groupName, Func<EvcVerificationTest, bool> filter, IObservable<Func<EvcVerificationTest, bool>> parentFilter = null, int sortOrder = 99)
