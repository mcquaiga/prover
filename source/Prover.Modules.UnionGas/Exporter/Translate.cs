...
namespace Prover.Modules.UnionGas.Exporter
{
    public static class Translate
    {
        ...
        private static VerificationTest TranslateVerificationTest(EvcVerificationTest test)
        {
        ...
        private static VolumeTest TranslateVolumeTest(EvcVerificationTest vt)
        {
        ...
        private static SuperFactorTest TranslateSuperFactorTest(EvcVerificationTest vt)
        {
        ...
        private static TemperatureTest TranslateTemperatureTest(EvcVerificationTest vt)
        {
        ...
        private static PressureTest TranslatePressureTest(EvcVerificationTest vt)
        {
