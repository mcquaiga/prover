...
namespace Prover.GUI.Screens.Modules.QAProver.Screens.Designer
{
    public class TestRunViewModelDesignTime
    {
        private Instrument _instrument;

        public TestRunViewModelDesignTime()
        {
            _instrument = JsonConvert.DeserializeObject<Instrument>(_json);
        }
