...
namespace Domain.Calculators
{
    public static class Pressure
    {
        ...
        public static decimal ConvertToUnits(decimal value, PressureUnits from, PressureUnits to)
        {
        ...
        public static decimal GetFactor(decimal baseValue, decimal gasValue)
        {
            if (baseValue == 0)
